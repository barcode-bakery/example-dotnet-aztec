...
```
PM> dotnet add PROJECT package BarcodeBakery.BarcodeAztec --version 3.0.1
```
...
### Saving a Aztec to a `MemoryStream`
```csharp
...
<br />
<img src="https://www.barcodebakery.com/images/aztec-github.png">


[1]: https://www.barcodebakery.com
[2]: https://www.barcodebakery.com/en/docs/dotnet/barcode/aztec/api
[3]: https://www.barcodebakery.com/en/purchase
[4]: https://www.barcodebakery.com/en/docs/dotnet/barcode/aztec/download
